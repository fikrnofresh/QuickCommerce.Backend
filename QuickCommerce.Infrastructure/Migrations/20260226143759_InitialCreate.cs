        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    agreement_start_date = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    agreement_end_date = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_deliverypartnerbeats_deliverypartners_deliverypartnerid",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_store_franchise_franchise_id",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_deliverypartnerbeats_deliverypartnerid",
                table: "deliverypartnerbeats",
                column: "deliverypartnerid");

            migrationBuilder.CreateIndex(
                name: "ix_franchise_code",
                table: "franchise",
                column: "code",
                unique: true);
