...
namespace QuickCommerce.Infrastructure.Migrations
{
    ...
    [Migration("20260302120915_InitialEnterpriseStructure")]
    partial class InitialEnterpriseStructure
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("QuickCommerce.Core.Entities.Store", b =>
                {
                    ...
                    b.Property<decimal?>("FixedPlatformFee")
                        .HasColumnType("decimal(10,2)")
                        .HasColumnName("fixedplatformfee");
                    ...
                    b.Property<decimal>("PlatformFeePercentage")
                        ...
                        .HasColumnName("platformfeepercentage");
            ...
            modelBuilder.Entity("QuickCommerce.Core.Entities.InventoryMovement", b =>
                {
                    ...
                    b.HasOne("QuickCommerce.Core.Entities.Store", "Store")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_inventory_movements_stores_storeid");
            ...
            modelBuilder.Entity("QuickCommerce.Core.Entities.StoreProduct", b =>
                {
                    ...
                    b.HasOne("QuickCommerce.Core.Entities.Store", "Store")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_storeproducts_stores_storeid");
            ...
            modelBuilder.Entity("QuickCommerce.Core.Entities.UserStore", b =>
                {
                    b.HasOne("QuickCommerce.Core.Entities.Store", "Store")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_user_stores_stores_store_id");
